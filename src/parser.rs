...
/// # Example
/// ```
/// use fppc::parser::parse;
/// let pattern = parse("(x:Person)-[:KNOWS]->(y)").unwrap();
/// ```
pub fn parse(input: &str) -> Result<PathPattern, ParseError<'_>> {
    grammar::PathPatternParser::new().parse(input)
}
...
mod tests {
    use super::*;
    use crate::ast::{
        BaseType, BinOpKind, Constant, Descriptor, DescriptorType, EdgeDirection, Expr, LabelType,
        PropertyType, Quantifier, SimpleType, UnOpKind, Var,
    };
    ...
    #[test]
    fn test_descriptor() {
        let result = parse("(x:Person)").unwrap();
        let expected = PathPattern::Node(Descriptor {
            variable: Some(Var("x".to_string())),
            descriptor_type: DescriptorType {
    ...
    fn test_descriptor_record() {
        let result = parse("(x :Person {a: int})").unwrap();
    ...
    fn test_descriptor_record_multiple() {
        let result = parse("(:Person {a: int, b: bool})").unwrap();
        let mut props = HashMap::new();
        props.insert("a".to_string(), SimpleType::Base(BaseType::Int));
    ...
    fn test_descriptor_no_label() {
        let result = parse("(:{a: int, b: bool})").unwrap();
        let mut props = HashMap::new();
        props.insert("a".to_string(), SimpleType::Base(BaseType::Int));
        props.insert("b".to_string(), SimpleType::Base(BaseType::Bool));
        let expected = PathPattern::Node(Descriptor {
    ...
    #[test]
    fn test_label_and() {
        let result = parse("(:Person & Company)").unwrap();
        let expected = PathPattern::Node(Descriptor {
            variable: None,
            descriptor_type: DescriptorType {
                label: LabelType::and(
    ...
    fn test_filter_attribute_gt() {
        let result = parse("(x where x.a>10)").unwrap();
    ...
    #[test]
    fn test_filter_and() {
        let result = parse("(x where 11>10 and (1 = 2 or 3>='1'))").unwrap();
        let expected = PathPattern::filter(
            PathPattern::Node(Descriptor {
                variable: Some(Var("x".to_string())),
                descriptor_type: DescriptorType {
    ...
    fn test_filter_on_edge() {
        let result = parse("(x)-[y where y.a>10]->(z)").unwrap();
        let x = PathPattern::Node(Descriptor {
            variable: Some(Var("x".to_string())),
            descriptor_type: DescriptorType {
                label: LabelType::Star,
    ...
    fn test_prioritization() {
        let result = parse("(x where 11 = 10 and 1 = 2 or 1=2)").unwrap();
        let expected = PathPattern::filter(
            PathPattern::Node(Descriptor {
                variable: Some(Var("x".to_string())),
                descriptor_type: DescriptorType {
    ...
    fn test_simple_logical() {
        let result = parse("(x where true and 1>2)").unwrap();
        let expected = PathPattern::filter(
            PathPattern::Node(Descriptor {
                variable: Some(Var("x".to_string())),
                descriptor_type: DescriptorType {
    ...
    fn test_simple_arithmetic() {
        let result = parse("(x where x.a>x.b>1)").unwrap();
        let expected = PathPattern::filter(
            PathPattern::Node(Descriptor {
                variable: Some(Var("x".to_string())),
                descriptor_type: DescriptorType {
    ...
    #[test]
    fn test_unop_1() {
        let result = parse("(x WHERE not x.status)").unwrap();
        let expected = PathPattern::filter(
            PathPattern::Node(Descriptor {
                variable: Some(Var("x".to_string())),
                descriptor_type: DescriptorType {
    ...
    #[test]
    fn test_unop_2() {
        let result = parse("(x WHERE -x.status>0)").unwrap();
        let expected = PathPattern::filter(
            PathPattern::Node(Descriptor {
                variable: Some(Var("x".to_string())),
                descriptor_type: DescriptorType {
